...
function Footer() {
  return (
    <section className="py-10 bg-violet-200 sm:pt-16 lg:pt-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            ...
            <p className="text-base leading-relaxed text-gray-600 mt-7">
              Promoting growth through innovative training and consulting
              solutions. Dedicated to continuous learning to thrive in dynamic
        ...
        <p className="text-sm text-center text-gray-600">
          © Copyright 2025, All Rights Reserved by Recertifie
        </p>
      </div>
    </section>
  );
