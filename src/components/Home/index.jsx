...
function Home() {
  return (
    <Layout>
    <div class="py-16 bg-gradient-to-r from-pink-50 to-purple-100">
          ...
          <div class="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
            ...
            <div class="md:7/12 lg:w-6/12">
              <h2 class="text-2xl text-gray-900 font-bold md:text-4xl">
                Explore Our Webinar Programs
              </h2>
              <p class="mt-6 text-gray-600">
                At Recertifie, we’re committed to the power of education to
                drive change. Our goal is to empower individuals and
                organizations globally through top-tier online training programs
                that unlock potential and promote lasting success.
              </p>
            </div>
          </div>
        </div>
